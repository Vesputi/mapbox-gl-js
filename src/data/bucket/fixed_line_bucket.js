...
const fixedLineInterface = {
    ...
    paintAttributes: [
        ...
        {property: 'fixed-line-stroke-width'},
        {property: 'fixed-line-stroke-opacity'}
    ]
};
...
const LayoutVertexArrayType = createVertexArrayType(fixedLineInterface.layoutAttributes);
 ...
 * @private
 */
class FixedLineBucket implements Bucket {
...
FixedLineBucket.programInterface = fixedLineInterface;

module.exports = FixedLineBucket;
