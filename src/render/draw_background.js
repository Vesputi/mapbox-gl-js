...
function drawBackground(painter: Painter, sourceCache: SourceCache, layer: BackgroundStyleLayer) {
    ...
    const properties = new PossiblyEvaluated({
        "background-color": new PossiblyEvaluatedPropertyValue({kind: 'constant', value: color}),
        "background-opacity": new PossiblyEvaluatedPropertyValue({kind: 'constant', value: opacity})
    });
